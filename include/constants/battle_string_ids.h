...
enum StringID
{
    ...
    STRINGID_MIASMASETTLED,
    STRINGID_MIASMACHOKES,
    STRINGID_MIASMASUBSIDED,
    STRINGID_POLLENSTARTED,
    STRINGID_POLLENDENSE,
    STRINGID_POLLENSUBSIDED,
    ...
    STRINGID_MIASMAISCHOKING,
    STRINGID_POLLENISDENSE,
...
enum MoveWeatherChangeStringID
{
    ...
    B_MSG_STARTED_SNOW,
    B_MSG_STARTED_FOG,
    B_MSG_STARTED_MIASMA,
    B_MSG_STARTED_POLLEN,
};
...
enum WeatherEndStringID
{
    ...
    B_MSG_WEATHER_END_MIASMA,
    B_MSG_WEATHER_END_POLLEN,
...
enum WeatherTurnStringID
{
    ...
    B_MSG_WEATHER_TURN_MIASMA,
    B_MSG_WEATHER_TURN_POLLEN,
};
